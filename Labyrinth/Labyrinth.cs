...
namespace Labyrinth
{
    public partial class Labyrinth
    {
        ...
        public Labyrinth(string ascii_map)
        {
            ...
            parser.StartPositionFound += OnStartPositionFound;
        ...
        /// <summary>
        /// Event handler for the start position found event.
        /// </summary>
        private void OnStartPositionFound(object? sender, Events.StartEventArgs e)
        {
            _start = (e.X, e.Y);
        }
